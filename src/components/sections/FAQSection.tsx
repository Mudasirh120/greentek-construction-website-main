...
export default function FAQSection() {
  ...
  return (
    <section className="bg-white py-12 lg:py-24 overflow-hidden" aria-labelledby="faq-heading">
      <div className="mx-auto max-w-4xl px-6">
        ...
        >
          ...
          <div className="text-center mb-20 md:mb-28">
            ...
            <h2 id="faq-heading" className="text-[1.625rem] md:text-[2.5rem] font-bold leading-[1.2] tracking-tight text-slate-950">
          ...
          <div className="space-y-4">
            {faqItems.map((item, index) => (
              ...
              >
                ...
                >
                  <span className="text-[1.25rem] md:text-[1.5rem] font-bold leading-[1.3] text-slate-950 pr-8">
                    {item.question}
                  </span>
