      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 bg-zinc-50/50 rounded-[3rem] p-3 sm:p-4 md:p-6 lg:p-8 border border-zinc-100 gap-6 md:gap-10">
            ...
            {/* Pillar 1: Energy */}
            <div className="bg-white rounded-[2.5rem] p-6 md:p-8 shadow-sm border border-zinc-100 group transition-all duration-500 hover:shadow-2xl hover:shadow-green-900/5 hover:-translate-y-1">
