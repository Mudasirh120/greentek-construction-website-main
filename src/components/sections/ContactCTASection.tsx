...
export default function ContactCTASection() {
  return (
    <section className="bg-white py-12 lg:py-24 border-t border-zinc-100">
      <div className="mx-auto max-w-7xl px-6">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          {/* Left: Content & Actions */}
          <div className="text-center lg:text-left flex flex-col items-center lg:items-start">
            <h2 className="text-[1.625rem] md:text-[2.5rem] font-bold leading-[1.2] tracking-tight text-zinc-900 text-center lg:text-left">
              Ready to Discuss <br />
            ...
            <div className="mt-12 flex flex-col sm:flex-row justify-center lg:justify-start gap-3 w-full sm:w-auto">
              <Link 
                href="/contact" 
                className="inline-flex items-center justify-center px-6 md:px-8 py-4 rounded-full bg-green-600 text-sm md:text-[15px] font-bold hover:bg-green-700 transition-all shadow-xl shadow-green-900/20 active:scale-95"
              >
                Request a Consultation
              </Link>
              <Link 
                href="/services" 
                className="inline-flex items-center justify-center px-6 md:px-8 py-4 rounded-full bg-zinc-50 border border-zinc-200 text-zinc-900 text-sm md:text-[15px] font-bold hover:bg-zinc-100 transition-all active:scale-95"
              >
                View Our Services
              </Link>
            </div>
