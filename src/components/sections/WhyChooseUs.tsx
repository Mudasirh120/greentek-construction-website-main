...
export default function WhyChooseUs() {
  ...
  return (
    <section className="relative bg-white py-12 lg:py-24 overflow-hidden" aria-labelledby="why-choose-heading">
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        ...
        <div ref={headingRef} className="text-center max-w-4xl mx-auto mb-16 md:mb-20">
          ...
          <h2 id="why-choose-heading" className="text-[1.625rem] md:text-[2.5rem] font-bold leading-[1.2] tracking-tight text-slate-950">
            Why Choose Us
          </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
          {features.map((feature, idx) => (
            <div 
              key={idx}
              className="group relative bg-white border border-zinc-100 p-6 md:p-8 rounded-[2.5rem] transition-all duration-500 hover:shadow-[0_32px_64px_-16px_rgba(22,163,74,0.1)] hover:-translate-y-1"
            >
