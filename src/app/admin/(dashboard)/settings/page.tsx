  ...
  return (
    <div>
      ...
      <form
        ...
        className="space-y-6 bg-white border border-zinc-200 rounded-xl p-6"
      >
        <div>
        ...
        <div>
          <label className="block text-xs font-semibold text-zinc-600 mb-1">
            ...
            <code className="bg-zinc-100 px-1 rounded">value | label</code>
          </label>
          <textarea
            name="stats"
        ...
        <div>
          <label className="block text-xs font-semibold text-zinc-600 mb-1">
            ...
            <code className="bg-zinc-100 px-1 rounded">title | description</code>
          </label>
          <textarea
            name="whyChooseUs"
