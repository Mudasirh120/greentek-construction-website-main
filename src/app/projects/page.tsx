  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 bg-white">
        ...
        <section className="py-12 lg:py-24 border-b border-zinc-100 bg-zinc-50/30">
        ...
        <section className="py-12 lg:py-24 bg-zinc-50 border-t border-zinc-100">
          <div className="mx-auto max-w-3xl px-6 text-center">
            <h2 className="text-[1.625rem] md:text-[2.5rem] font-bold leading-[1.2] tracking-tight text-zinc-900">Have a Project in Mind?</h2>
            ...
            <div className="mt-10">
              <a href="/contact" className="inline-flex items-center justify-center px-6 md:px-8 py-4 rounded-full bg-zinc-900 text-white font-bold hover:bg-green-700 transition-all">
