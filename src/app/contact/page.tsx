...
function ContactMethod({ icon, title, value, index }: { icon: React.ReactNode; title: string; value: React.ReactNode; index: number }) {
  ...
  return (
    ...
    >
      ...
      <div>
        <h3 className="text-xs font-black uppercase tracking-widest text-zinc-400 mb-0.5">{title}</h3>
      ...
      <main className="flex-1">
        ...
        <section className="relative pt-20 md:pt-24 pb-8 overflow-hidden">
          ...
          >
            ...
            <h1 className="text-[2rem] md:text-[3.5rem] font-extrabold leading-[1.15] text-zinc-950 mb-8">
            ...
            <div className="grid lg:grid-cols-12 gap-8 md:gap-12 items-start">
              ...
              <div className="lg:col-span-5 space-y-4">
                ...
                <div className="p-5 rounded-2xl border border-zinc-100 bg-zinc-50/30">
                  <h4 className="text-xs font-black uppercase tracking-[0.3em] text-zinc-400 mb-3">Follow our progress</h4>
              ...
              >
                <div className="mb-6">
                  <h2 className="text-xl font-bold text-zinc-950 tracking-tight mb-1">Send an Enquiry</h2>
                ...
                <form className="space-y-4">
                  <div className="grid md:grid-cols-2 gap-4">
                    <div className="space-y-1">
                      <label htmlFor="first_name" className="text-xs font-black uppercase tracking-[0.2em] text-zinc-400 ml-2">First Name</label>
                      <input type="text" id="first_name" className="w-full px-5 py-4 rounded-xl bg-zinc-50 border border-transparent focus:bg-white focus:border-green-600 focus:ring-4 focus:ring-green-600/5 transition-all outline-none font-bold text-zinc-900 placeholder:text-zinc-300 text-xs" placeholder="John" />
                    </div>
                    <div className="space-y-1">
                      <label htmlFor="last_name" className="text-xs font-black uppercase tracking-[0.2em] text-zinc-400 ml-2">Last Name</label>
                      <input type="text" id="last_name" className="w-full px-5 py-4 rounded-xl bg-zinc-50 border border-transparent focus:bg-white focus:border-green-600 focus:ring-4 focus:ring-green-600/5 transition-all outline-none font-bold text-zinc-900 placeholder:text-zinc-300 text-xs" placeholder="Doe" />
                    </div>
                  </div>
                  
                  <div className="space-y-1">
                    <label htmlFor="email" className="text-xs font-black uppercase tracking-[0.2em] text-zinc-400 ml-2">Email Address</label>
                    <input type="email" id="email" className="w-full px-5 py-4 rounded-xl bg-zinc-50 border border-transparent focus:bg-white focus:border-green-600 focus:ring-4 focus:ring-green-600/5 transition-all outline-none font-bold text-zinc-900 placeholder:text-zinc-300 text-xs" placeholder="john@example.com" />
                  </div>

                  <div className="space-y-1">
                    <label htmlFor="service" className="text-xs font-black uppercase tracking-[0.2em] text-zinc-400 ml-2">Service Required</label>
                    <div className="relative">
                      <select id="service" className="w-full px-5 py-4 rounded-xl bg-zinc-50 border border-transparent focus:bg-white focus:border-green-600 focus:ring-4 focus:ring-green-600/5 transition-all outline-none font-bold text-zinc-900 appearance-none cursor-pointer text-xs">
                  ...
                  <div className="space-y-1">
                    <label htmlFor="message" className="text-xs font-black uppercase tracking-[0.2em] text-zinc-400 ml-2">Project Brief</label>
                    <textarea id="message" rows={3} className="w-full px-5 py-4 rounded-xl bg-zinc-50 border border-transparent focus:bg-white focus:border-green-600 focus:ring-4 focus:ring-green-600/5 transition-all outline-none font-bold text-zinc-900 placeholder:text-zinc-300 resize-none text-xs" placeholder="Tell us about your requirements..."></textarea>
                  </div>

                  <button type="submit" className="w-full py-5 rounded-full bg-zinc-900 text-white font-black text-sm uppercase tracking-[0.3em] hover:bg-green-600 transition-all duration-500 shadow-xl shadow-zinc-900/10 hover:shadow-green-900/20 hover:-translate-y-1 active:scale-95">
                    Send Message
                  </button>
                </form>
              </div>
        ...
        <section className="py-16 md:py-20 bg-zinc-50">
          <div className="mx-auto max-w-7xl px-6">
            ...
            >
              ...
              <h2 className="text-[1.625rem] md:text-[2.5rem] font-bold leading-[1.2] tracking-tight text-zinc-900">Visit Our Office</h2>
              <div className="w-12 h-1 bg-green-600 rounded-full mx-auto mt-5 mb-6" />
              <p className="text-base text-zinc-600 font-medium">
                Our central office is located in Solihull, allowing us to efficiently serve 
