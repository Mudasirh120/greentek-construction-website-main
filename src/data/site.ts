  ...
  services: [
    {
      ...
      formCategory: "solar_storage",
      highlights: [
        "Free, no-obligation site survey and system design",
        "High-efficiency panels from trusted brands including AIKO, JinkoSolar and Trinasolar",
        "Growatt and SolaX inverter and battery storage options",
        "Reduces reliance on grid electricity and can improve EPC rating",
      ],
    },
    {
      slug: "air-source-heat-pump-installations",
      ...
      formCategory: "heating_boiler",
      highlights: [
        "Low-carbon heating suited to residential and commercial properties",
    ...
    {
      slug: "external-wall-insulation-rendering",
    ...
    },
    {
      ...
      description:
        "Single storey extensions delivered from design through to construction and final finishing, adding space and value to your home.",
  ...
  projects: [
    {
      ...
      service: "solar-pv-installations",
    ...
    },
    {
      ...
      service: "air-source-heat-pump-installations",
    ...
    },
    {
      ...
      service: "external-wall-insulation-rendering",
      category: "Home Improvement",
  ...
  locations: [
    {
      ...
      tagline: "Our home base since 2020",
      blurb:
        "Solihull and the wider Birmingham metro area is where Greentek is based, so homeowners here get same-week surveys and the fastest turnaround on solar, heating, insulation and renovation work.",
      nearbyAreas: ["Sutton Coldfield", "West Bromwich", "Sandwell", "Redditch"],
    },
    {
      slug: "wolverhampton",
      name: "Wolverhampton",
      ...
      tagline: "Local crews, no subcontractors",
      blurb:
        "Our in-house teams cover Wolverhampton and the surrounding Black Country regularly, delivering solar, heating, insulation and renovation projects without passing the job to subcontractors.",
      nearbyAreas: ["Dudley", "Telford", "Stourbridge", "Halesowen"],
    },
    {
      slug: "coventry",
      name: "Coventry",
      ...
      tagline: "Trusted local installers",
      blurb:
        "Homeowners across Coventry and Warwickshire work with Greentek for solar PV, air source heat pumps, insulation and full property renovations, backed by a written warranty on every job.",
      nearbyAreas: ["Sutton Coldfield", "Redditch", "Bromsgrove", "Kidderminster"],
    },
    {
      slug: "dudley",
      name: "Dudley",
      ...
      tagline: "Serving the Black Country",
      blurb:
        "From Dudley through the wider Black Country, Greentek delivers renewable energy installations and construction projects with a clear, fixed-price quote and one accountable team.",
      nearbyAreas: ["Stourbridge", "Halesowen", "Smethwick", "Wolverhampton"],
    },
    {
      slug: "cardiff",
      name: "Cardiff",
      ...
      tagline: "Renewable energy & renovation in Wales",
      blurb:
        "Greentek brings the same in-house solar, heating, insulation and renovation service to Cardiff and the surrounding South Wales area, with local surveys and honest, fixed-price quotes.",
      nearbyAreas: ["Newport", "Bridgend", "Neath", "Merthyr Tydfil"],
    },
    {
      slug: "swansea",
      name: "Swansea",
      ...
      tagline: "Renewable energy & renovation in Wales",
      blurb:
        "In Swansea and the surrounding coastline, Greentek installs solar PV and heat pump systems and delivers insulation and renovation projects for homeowners looking to cut energy costs.",
      nearbyAreas: ["Neath", "Port Talbot", "Bridgend", "Wrexham"],
    },
  ],
};
